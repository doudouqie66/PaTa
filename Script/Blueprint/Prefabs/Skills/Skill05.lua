---@class Skill05_C:PESkillTemplate_Base_C
--Edit Below--
local Skill05 = {}

function Skill05:DestroyMyself()
...
--[[----------------------检查粑粑是否允许放置------------------------]]
function Skill05:CanActivateSkill_BP()
    ...
    return Skill05.SuperClass.CanActivateSkill_BP(self)
end
