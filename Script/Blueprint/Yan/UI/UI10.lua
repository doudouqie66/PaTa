...
--[[----------------------刷新塔内计时奖励界面------------------------]]
function UI10:RefreshTowerRewards()
...
function UI10:Button_113_OnClicked()
    -- 打开奖杯商店
