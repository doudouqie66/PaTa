...
SoundMgr.SoundName = {
    ...
    Boom = "Boom", -- 爆炸音效
    Banana = "Banana", -- 香蕉音效
    CJ_End = "CJ_End", -- 抽奖结束音效
    CJ_In_Progress = "CJ_In_Progress", -- 抽奖进行中音效
    ...
    Attention02 = "Attention02", -- 怪物靠近警示音效二
...
SoundMgr.SoundPath = {
    ...
    CJ_End = RootPath .. "Asset/WwiseEvent/CJEnd.CJEnd", -- 抽奖结束音效
    CJ_In_Progress = RootPath .. "Asset/WwiseEvent/CJing.CJing", -- 抽奖进行中音效
    ...
    Attention02 = RootPath .. "Asset/WwiseEvent/Attention02.Attention02", -- 怪物靠近警示音效二
